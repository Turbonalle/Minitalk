...
/*   Updated: 2022/12/18 11:21:03 by jbagger          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

static int	convert_signed(long long int num, int base, int len)
{
	static char	*digits;
...
static int	convert_unsigned(unsigned long int num, int base, char c, int len)
{
	static char	*digits;
	static char	buffer[50];
	char		*result;
